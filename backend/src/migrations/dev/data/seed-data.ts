...
export const data = {
  users: [
    ...
    {
      _id: new ObjectId('a00000000000000000000002'),
    ...
    {
      _id: new ObjectId('f00000000000000000000001'),
  ...
  authentications: [
    {
      _id: new ObjectId('5c46906ac07baa98e0ce4a32'),
      local: {
        email: 'admin@domain.com',
        hashedPassword: '$2a$08$fkDiwuscJSWmDqEYo86xpejj7hVPGUkVeOMdRQC/dJhXFSjqPPqky',
      },
      userId: new ObjectId('a00000000000000000000001'),
  ...
  organizations: [
    {
      _id: new ObjectId('a00000000000000000000000'),
      name: 'Org A',
    ...
    {
      _id: new ObjectId('b00000000000000000000000'),
      name: 'Org B',
    ...
    {
      _id: new ObjectId('c00000000000000000000000'),
      name: 'Org C',
  ...
  accesspermissions: [
    {
      _id: new ObjectId('a00000000000000000000011'),
      roles: ['user'],
      organizations: [
        {
          organizationRoles: ['admin'],
          _id: new ObjectId('5c46906bc07baa98e0ce4a34'),
          primary: true,
          orgId: new ObjectId('a00000000000000000000000'),
        },
      ],
      userId: new ObjectId('a00000000000000000000001'),
    ...
    {
      _id: new ObjectId('a00000000000000000000022'),
      roles: ['user'],
      organizations: [
        {
          organizationRoles: ['member'],
          _id: new ObjectId('5c46906bc07baa98e0ce4a38'),
          primary: true,
          orgId: new ObjectId('a00000000000000000000000'),
        },
      ],
    ...
    {
      _id: new ObjectId('b00000000000000000000011'),
      roles: ['user'],
      organizations: [
        {
          organizationRoles: ['admin'],
          _id: new ObjectId('5c46906bc07baa98e0ce4a3d'),
          primary: true,
          orgId: new ObjectId('b00000000000000000000000'),
        },
      ],
      userId: new ObjectId('b00000000000000000000001'),
    ...
    {
      _id: new ObjectId('c00000000000000000000011'),
      roles: ['groupAdmin'],
      organizations: [
        {
          organizationRoles: ['admin'],
          _id: new ObjectId('5c46906bc07baa98e0ce4a43'),
          primary: true,
          orgId: new ObjectId('c00000000000000000000000'),
        },
        {
          organizationRoles: ['facilitator'],
          _id: new ObjectId('5c46906bc07baa98e0ce4a42'),
          primary: false,
          orgId: new ObjectId('a00000000000000000000000'),
        },
      ],
