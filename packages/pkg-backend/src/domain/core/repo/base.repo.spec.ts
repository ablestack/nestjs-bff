...
describe('GIVEN a Repo', () => {
  ...
  describe('WHEN find is called with an org-scoped and user-scoped Repo', () => {
    it(`WITH valid authorization 
      ...
      try {
        result = await fooRepo.find({ name: TestFooEntityLiterals.FE_Ua2Oa.name }, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember });
      } catch (e) {
        error = e;
      }
  ...
  describe('WHEN find is called twice with an org-scoped and user-scoped Repo', () => {
    it(`WITH valid authorization 
      ...
      try {
        await fooRepo.find({ name: TestFooEntityLiterals.FE_Ua2Oa.name }, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember });
        await fooRepo.find({ name: TestFooEntityLiterals.FE_Ua2Oa.name }, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember });
      } catch (e) {
        error = e;
      }
    ...
    it(`WITH valid authorization
      ...
      try {
        await fooRepo.find({ name: TestFooEntityLiterals.FE_Ua2Oa.name }, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember, skipCache: true });
        await fooRepo.find({ name: TestFooEntityLiterals.FE_Ua2Oa.name }, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember, skipCache: true });
      } catch (e) {
        error = e;
      }
  ...
  describe('WHEN patch is called with an org-scoped and user-scoped Repo', () => {
    it(`WITH valid authorization 
      ...
      try {
        result = await fooRepo.patch(patchFoo, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember });
      } catch (e) {
        error = e;
      }
    ...
    it(`WITH invalid authorization 
      ...
      try {
        result = await fooRepo.patch(patchFoo, { accessPermissions: TestAuthorizationLiterals.Az_Ub1user_ObAdmin });
      } catch (e) {
        error = e;
  ...
  describe('WHEN update is called with an org-scoped and user-scoped Repo', () => {
    it(`WITH valid authorization 
      ...
      try {
        result = await fooRepo.update(TestFooEntityLiterals.FE_Ua2Oa, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember });
      } catch (e) {
        error = e;
      }
    ...
    it(`WITH no orgId 
      ...
      try {
        result = await fooRepo.update(fooWithMissingOrgId, { accessPermissions: TestAuthorizationLiterals.Az_Ua2User_OaMember });
      } catch (e) {
        error = e;
      }
    ...
    it(`WITH invalid authorization 
      ...
      try {
        result = await fooRepo.update(TestFooEntityLiterals.FE_Ua2Oa, { accessPermissions: TestAuthorizationLiterals.Az_Ub1user_ObAdmin });
      } catch (e) {
        error = e;
      }
